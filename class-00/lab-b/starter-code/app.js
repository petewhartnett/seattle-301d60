...
// Note that the arrow function will cause this code to break!
 console.log(joe);
//old school funciton has to be used for constructors using this. 
...
//function has to be used for prototypes
// TODO: After viewing the previous console.log(), return the code to a working state.
...
//This is the student contstructor holding joe's information when using old school function, and window object with arrow
// 2. What is "this" when joe.scopeArrow() is invoked?
//This is the student contstructor holding joe's information when using old school function, and window object with arrow
// 3. Explain why "this" is different when an arrow function is used.
// arrowfunction binds the method to the window object so it does not work properly with constructor functions.